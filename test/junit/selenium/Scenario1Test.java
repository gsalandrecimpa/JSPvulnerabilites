...
public class Scenario1Test {
  ...
  @Before
  public void setUp() {
	System.setProperty("webdriver.chrome.driver", "C:\\Users\\Administrator\\Desktop\\JAVA ext libraries\\selenium\\chromedriver.exe");
    driver = new ChromeDriver();
    js = (JavascriptExecutor) driver;
    vars = new HashMap<String, Object>();
    ModelVuln model = new ModelVuln();
    model.deleteUser("testselenium");
  }
  @After
  ...
  public void scenario1crationadministrationdecompteacces() {
    ...
    driver.findElement(By.id("repwd")).clear();
